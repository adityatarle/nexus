...
class SubcategoryController extends Controller
{
    ...
    {
        $query = AgricultureSubcategory::active()->ordered()->withCount('products');
        ...
        $subcategories = $query->get()->map(function ($subcategory) {
            ...
            return [
                ...
                'category_id' => $subcategory->agriculture_category_id,
                'category' => [
                    'id' => $subcategory->category->id ?? null,
                    'name' => $subcategory->category->name ?? null,
                    'slug' => $subcategory->category->slug ?? null,
                ],
     ...
     */
    public function show(AgricultureSubcategory $subcategory, Request $request)
    {
