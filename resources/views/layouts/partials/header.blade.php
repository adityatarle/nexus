...
<html lang="en">
  ...
  <body>
    ...
    <div class="offcanvas offcanvas-end" data-bs-scroll="true" tabindex="-1" id="offcanvasCart" style="width: 400px;">
      <div class="offcanvas-header border-bottom">
        <h5 class="offcanvas-title">
          <svg width="24" height="24" class="me-2"><use xlink:href="#shopping-bag"></use></svg>
          Shopping Cart
          <span class="badge bg-primary rounded-pill ms-2">{{ $cartCount ?? 0 }}</span>
        </h5>
      ...
      <div class="offcanvas-body p-0">
        ...
        @if(empty($cart))
          <div class="text-center py-5">
            <svg width="80" height="80" class="text-muted mb-3"><use xlink:href="#shopping-bag"></use></svg>
            <h5 class="text-muted">Your cart is empty</h5>
            <p class="text-muted">Add some products to get started!</p>
            <a href="{{ route('agriculture.products.index') }}" class="btn btn-primary" data-bs-dismiss="offcanvas">Browse Products</a>
          </div>
        @else
          <div class="cart-items" style="max-height: calc(100vh - 250px); overflow-y: auto;">
                ...
                <div class="cart-item border-bottom p-3">
                  <div class="d-flex gap-3">
                    ...
                    <div class="flex-grow-1">
                      <h6 class="mb-1">
                        <a href="{{ route('agriculture.products.show', $product->slug) }}" class="text-dark text-decoration-none" data-bs-dismiss="offcanvas">
          ...
          <div class="offcanvas-footer border-top p-3">
            <div class="d-flex justify-content-between align-items-center mb-3">
              ...
              <h4 class="mb-0 text-primary">₹{{ number_format($cartTotal, 2) }}</h4>
            </div>
            <div class="d-grid gap-2">
              <a href="{{ route('agriculture.cart.index') }}" class="btn btn-primary btn-lg" data-bs-dismiss="offcanvas">
                View Full Cart
              </a>
              <a href="{{ route('agriculture.checkout.index') }}" class="btn btn-success btn-lg" data-bs-dismiss="offcanvas">
                Proceed to Checkout
              </a>
            </div>
          </div>
