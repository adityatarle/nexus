                ...
                <form action="{{ route('admin.offers.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select @error('offer_type') is-invalid @enderror" 
                            ...
                            <option value="general" {{ old('offer_type') == 'general' ? 'selected' : '' }}>General (All Products)</option>
                            <option value="product" {{ old('offer_type') == 'product' ? 'selected' : '' }}>Specific Product</option>
                            <option value="category" {{ old('offer_type') == 'category' ? 'selected' : '' }}>Category</option>
                            <option value="subcategory" {{ old('offer_type') == 'subcategory' ? 'selected' : '' }}>Subcategory</option>
                        </select>
                        @error('offer_type')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                <div class="form-check">
                                    <input type="checkbox" class="form-check-input" id="for_customers" name="for_customers" value="1" {{ old('for_customers', true) ? 'checked' : '' }}>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                <div class="form-check">
                                    <input type="checkbox" class="form-check-input" id="for_dealers" name="for_dealers" value="1" {{ old('for_dealers') ? 'checked' : '' }}>
