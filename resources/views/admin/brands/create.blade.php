            ...
            <div class="card-body">
                <form action="{{ route('admin.brands.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" id="logo" name="logo" class="form-control @error('logo') is-invalid @enderror" value="{{ old('logo') }}" placeholder="https://example.com/logo.png">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="url" id="website" name="website" class="form-control @error('website') is-invalid @enderror" value="{{ old('website') }}" placeholder="https://example.com">
                        @error('website')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
