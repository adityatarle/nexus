...
<div class="row">
    <div class="col-lg-4">
        <div class="card mb-4">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <a href="{{ route('admin.subcategories.edit', $subcategory) }}" class="btn btn-sm btn-outline-secondary">
            ...
            <div class="card-body">
                ...
                <div class="mb-3">
                    ...
                    <span class="text-muted">{{ $subcategory->description ?: '—' }}</span>
                </div>
                <div class="mb-3">
    ...
    <div class="col-lg-8">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h5 class="mb-0">Products in {{ $subcategory->name }}</h5>
                <a href="{{ route('admin.products.index', ['subcategory' => $subcategory->id]) }}" class="btn btn-sm btn-primary">View All</a>
            </div>
            <div class="card-body">
                ...
                <div class="text-center py-5">
                    ...
                    <p class="text-muted mb-0">No products found in this subcategory.</p>
                </div>
                @endif
            </div>
        </div>
